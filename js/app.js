// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || JSON.stringify(Object.keys(API_SITES).filter(apiKey => !API_SITES[apiKey].adult))); // 默认选中所有非成人内容API
